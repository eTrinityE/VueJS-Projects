    ...
    <div class="basket">
      <div class="items">
        <template v-if="productsInBag.length">
          <div v-for="(product, index) in productsInBag" :key="product.id" class="item">
            <div class="remove" @click="this.$store.dispatch('removeFromBag_Act', product.id)">Remove item</div>
